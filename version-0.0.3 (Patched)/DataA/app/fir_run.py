...
pit3 = open("Pits\\Pit - a1\\Pit-003.avo", "w")
pit4 = open("Pits\\Pit - a1\\Pit-004.avo", "w")
pit5 = open("Pits\\Pit - a1\\Pit-005.avo", "w")
pit6 = open("Pits\\Pit - a1\\Pit-006.avo", "w")
pit7 = open("Pits\\Pit - a1\\Pit-007.avo", "w")
pit8 = open("Pits\\Pit - a1\\Pit-008.avo", "w")
pit9 = open("Pits\\Pit - a1\\Pit-009.avo", "w")
pit10 = open("Pits\\Pit - a1\\Pit-010.avo", "w")
pit11 = open("Pits\\Pit - a1\\Pit-011.avo", "w")
pit12 = open("Pits\\Pit - a1\\Pit-012.avo", "w")
pit13 = open("Pits\\Pit - a1\\Pit-013.avo", "w")
pit14 = open("Pits\\Pit - a1\\Pit-014.avo", "w")
pit15 = open("Pits\\Pit - a1\\Pit-015.avo", "w")
pit16 = open("Pits\\Pit - a1\\Pit-016.avo", "w")
pit17 = open("Pits\\Pit - a1\\Pit-017.avo", "w")
pit18 = open("Pits\\Pit - a1\\Pit-018.avo", "w")
pit19 = open("Pits\\Pit - a1\\Pit-019.avo", "w")
pit20 = open("Pits\\Pit - a1\\Pit-020.avo", "w")
pit21 = open("Pits\\Pit - a1\\Pit-021.avo", "w")
pit22 = open("Pits\\Pit - a1\\Pit-022.avo", "w")
pit23 = open("Pits\\Pit - a1\\Pit-023.avo", "w")
pit24 = open("Pits\\Pit - a1\\Pit-024.avo", "w")
pit25 = open("Pits\\Pit - a1\\Pit-025.avo", "w")
pit26 = open("Pits\\Pit - a1\\Pit-026.avo", "w")
ram1 = open("Pits\\RAM\\RAM-address-1.avo", "w")
ram2 = open("Pits\\RAM\\RAM-address-2.avo", "w")
ram3 = open("Pits\\RAM\\RAM-address-3.avo", "w")
root = tk.Tk()
u = pit1.read()
p = pit2.read()
...
def show_popup(text):
    ...
    # Center the pop-up
    popup = tk.Label(overlay, text=text, font=("Arial", 16))
    popup.place(relx=0.5, rely=0.5, anchor=tk.CENTER)
    
    # Focus on the pop-up
    popup.focus_set()
    
    # Hide the pop-up and restore main window interactions
    def hide_popup(event=None):
        overlay.destroy()
        root.attributes('-disabled', False)
    
    # Bind the escape key to hide the pop-up
    popup.bind("<Escape>", hide_popup)
    # Bind a mouse click to hide the pop-up
    overlay.bind("<Button-1>", hide_popup)
    ...
    def log():
        def login():
            ...
            if username_entry.get() == u and password_entry.get() == p:
                ...
                icon1 = tk.Button(wallpaper, text="My Computer", command=lambda: show_popup("This feature is not available, with you version!"))
                icon1.grid(row=0, column=0, padx=10, pady=10)
                icon2 = tk.Button(wallpaper, text="X-Emailer", command=Emailer)
                ...
                toolt = Tooltip(icon2, "X-Emailer | Send Emails anonymously")
                ...
                def CD():
                    if 1 == 2:
                        pit0 = open(
                            "Pits\\Pit - a1\\Pit-000.avo", "r")
                        pit1 = open(
                            "Pits\\Pit - a1\\Pit-001.avo", "r")
                        pit2 = open(
                            "Pits\\Pit - a1\\Pit-002.avo", "r")
                        pit3 = open(
                            "Pits\\Pit - a1\\Pit-003.avo", "r")
                        pit4 = open(
                            "Pits\\Pit - a1\\Pit-004.avo", "r")
                        pit5 = open(
                            "Pits\\Pit - a1\\Pit-005.avo", "r")
                        pit6 = open(
                            "Pits\\Pit - a1\\Pit-006.avo", "r")
                        pit7 = open(
                            "Pits\\Pit - a1\\Pit-007.avo", "r")
                        pit8 = open(
                            "Pits\\Pit - a1\\Pit-008.avo", "r")
                        pit9 = open(
                            "Pits\\Pit - a1\\Pit-009.avo", "r")
                        pit10 = open(
                            "Pits\\Pit - a1\\Pit-010.avo", "r")
                        pit11 = open(
                            "Pits\\Pit - a1\\Pit-011.avo", "r")
                        pit12 = open(
                            "Pits\\Pit - a1\\Pit-012.avo", "r")
                        pit13 = open(
                            "Pits\\Pit - a1\\Pit-013.avo", "r")
                        pit14 = open(
                            "Pits\\Pit - a1\\Pit-014.avo", "r")
                        pit15 = open(
                            "Pits\\Pit - a1\\Pit-015.avo", "r")
                        pit16 = open(
                            "Pits\\Pit - a1\\Pit-016.avo", "r")
                        pit17 = open(
                            "Pits\\Pit - a1\\Pit-017.avo", "r")
                        pit18 = open(
                            "Pits\\Pit - a1\\Pit-018.avo", "r")
                        pit19 = open(
                            "Pits\\Pit - a1\\Pit-019.avo", "r")
                        pit20 = open(
                            "Pits\\Pit - a1\\Pit-020.avo", "r")
                        pit21 = open(
                            "Pits\\Pit - a1\\Pit-021.avo", "r")
                        pit22 = open(
                            "Pits\\Pit - a1\\Pit-022.avo", "r")
                        pit23 = open(
                            "Pits\\Pit - a1\\Pit-023.avo", "r")
                        pit24 = open(
                            "Pits\\Pit - a1\\Pit-024.avo", "r")
                        pit25 = open(
                            "Pits\\Pit - a1\\Pit-025.avo", "r")
                        pit26 = open(
                            "Pits\\Pit - a1\\Pit-026.avo", "r")
                        ram1 = open(
                            "Pits\\RAM\\RAM-address-1.avo", "r")
                        ram2 = open(
                            "Pits\\RAM\\RAM-address-2.avo", "r")
                        ram3 = open(
                            "Pits\\RAM\\RAM-address-3.avo", "r")
                        print("0 ", pit0.read())
                        print("1 ", pit1.read())
                        print("2 ", pit2.read())
                        print("3 ", pit3.read())
                ...
                def CDRD():
                    ...
                    pit9 = open("Pits\\Pit - a1\\Pit-009.avo", "w")
                    pit10 = open(
                        "Pits\\Pit - a1\\Pit-010.avo", "w")
                    pit11 = open(
                        "Pits\\Pit - a1\\Pit-011.avo", "w")
                    pit12 = open(
                        "Pits\\Pit - a1\\Pit-012.avo", "w")
                    pit13 = open(
                        "Pits\\Pit - a1\\Pit-013.avo", "w")
                    pit14 = open(
                        "Pits\\Pit - a1\\Pit-014.avo", "w")
                    pit15 = open(
                        "Pits\\Pit - a1\\Pit-015.avo", "w")
                    pit16 = open(
                        "Pits\\Pit - a1\\Pit-016.avo", "w")
                    pit17 = open(
                        "Pits\\Pit - a1\\Pit-017.avo", "w")
                    pit18 = open(
                        "Pits\\Pit - a1\\Pit-018.avo", "w")
                    pit19 = open(
                        "Pits\\Pit - a1\\Pit-019.avo", "w")
                    pit20 = open(
                        "Pits\\Pit - a1\\Pit-020.avo", "w")
                    pit21 = open(
                        "Pits\\Pit - a1\\Pit-021.avo", "w")
                    pit22 = open(
                        "Pits\\Pit - a1\\Pit-022.avo", "w")
                    pit23 = open(
                        "Pits\\Pit - a1\\Pit-023.avo", "w")
                    pit24 = open(
                        "Pits\\Pit - a1\\Pit-024.avo", "w")
                    pit25 = open(
                        "Pits\\Pit - a1\\Pit-025.avo", "w")
                    pit26 = open(
                        "Pits\\Pit - a1\\Pit-026.avo", "w")
                    pit0.write("True")
                    pit4.write(ttt)
                    pit5.write("Default")
                    pit6.write("Default")
                ...
                def dad():
                    menu.delete("Debug", "Disable Advanced Debugging")
                    menu.add_command(
                        label="Enable Advanced Debugging", command=ead)
                ...
                def ead():
                    ...
                    cash_menu.add_command(
                        label='Cash Debug', state="disabled", command=CD)
                    cash_menu.add_command(
                    ...
                    menu.add_command(label='PY term', command=Pyterm)
                    menu.delete("Enable Advanced Debugging")
                    menu.add_command(
                        label="Disable Advanced Debugging", command=dad)
        ...
        playsound.playsound(note)
        root.mainloop()
    log()


pit0 = pit0 = open("Pits\\Pit - a1\\Pit-000.avo", "r")
