...
pit0 = open("Pits\\Pit - a1\\Pit-000.txt", "r")
pit1 = open("Pits\\Pit - a1\\Pit-001.txt", "r")
pit2 = open("Pits\\Pit - a1\\Pit-002.txt", "r")
...
ram1 = open("Pits\\RAM\\RAM-address-1.txt", "w")
ram2 = open("Pits\\RAM\\RAM-address-2.txt", "w")
ram3 = open("Pits\\RAM\\RAM-address-3.txt", "w")
root = tk.Tk()
u = pit1.read()
p = pit2.read()
...
def pro():
    def log():
        def login():
            ...
            if username_entry.get() == u and password_entry.get() == p:
                ...
                def CD():
                    if 1 == 2:
                        pit0 = open(
                            "Pits\\Pit - a1\\Pit-000.txt", "r")
                        pit1 = open(
                            "Pits\\Pit - a1\\Pit-001.txt", "r")
                        pit2 = open(
                            "Pits\\Pit - a1\\Pit-002.txt", "r")
                        pit3 = open(
                            "Pits\\Pit - a1\\Pit-003.txt", "r")
                        pit4 = open(
                            "Pits\\Pit - a1\\Pit-004.txt", "r")
                        pit5 = open(
                            "Pits\\Pit - a1\\Pit-005.txt", "r")
                        pit6 = open(
                            "Pits\\Pit - a1\\Pit-006.txt", "r")
                        pit7 = open(
                            "Pits\\Pit - a1\\Pit-007.txt", "r")
                        pit8 = open(
                            "Pits\\Pit - a1\\Pit-008.txt", "r")
                        pit9 = open(
                            "Pits\\Pit - a1\\Pit-009.txt", "r")
                        pit10 = open(
                            "Pits\\Pit - a1\\Pit-010.txt", "r")
                        pit11 = open(
                            "Pits\\Pit - a1\\Pit-011.txt", "r")
                        pit12 = open(
                            "Pits\\Pit - a1\\Pit-012.txt", "r")
                        pit13 = open(
                            "Pits\\Pit - a1\\Pit-013.txt", "r")
                        pit14 = open(
                            "Pits\\Pit - a1\\Pit-014.txt", "r")
                        pit15 = open(
                            "Pits\\Pit - a1\\Pit-015.txt", "r")
                        pit16 = open(
                            "Pits\\Pit - a1\\Pit-016.txt", "r")
                        pit17 = open(
                            "Pits\\Pit - a1\\Pit-017.txt", "r")
                        pit18 = open(
                            "Pits\\Pit - a1\\Pit-018.txt", "r")
                        pit19 = open(
                            "Pits\\Pit - a1\\Pit-019.txt", "r")
                        pit20 = open(
                            "Pits\\Pit - a1\\Pit-020.txt", "r")
                        pit21 = open(
                            "Pits\\Pit - a1\\Pit-021.txt", "r")
                        pit22 = open(
                            "Pits\\Pit - a1\\Pit-022.txt", "r")
                        pit23 = open(
                            "Pits\\Pit - a1\\Pit-023.txt", "r")
                        pit24 = open(
                            "Pits\\Pit - a1\\Pit-024.txt", "r")
                        pit25 = open(
                            "Pits\\Pit - a1\\Pit-025.txt", "r")
                        pit26 = open(
                            "Pits\\Pit - a1\\Pit-026.txt", "r")
                        ram1 = open(
                ...
                def CDRD():
                    ...
                    pit9 = open("Pits\\Pit - a1\\Pit-009.txt", "w")
                    pit10 = open(
                        "Pits\\Pit - a1\\Pit-010.txt", "w")
                    pit11 = open(
                        "Pits\\Pit - a1\\Pit-011.txt", "w")
                    pit12 = open(
                        "Pits\\Pit - a1\\Pit-012.txt", "w")
                    pit13 = open(
                        "Pits\\Pit - a1\\Pit-013.txt", "w")
                    pit14 = open(
                        "Pits\\Pit - a1\\Pit-014.txt", "w")
                    pit15 = open(
                        "Pits\\Pit - a1\\Pit-015.txt", "w")
                    pit16 = open(
                        "Pits\\Pit - a1\\Pit-016.txt", "w")
                    pit17 = open(
                        "Pits\\Pit - a1\\Pit-017.txt", "w")
                    pit18 = open(
                        "Pits\\Pit - a1\\Pit-018.txt", "w")
                    pit19 = open(
                        "Pits\\Pit - a1\\Pit-019.txt", "w")
                    pit20 = open(
                        "Pits\\Pit - a1\\Pit-020.txt", "w")
                    pit21 = open(
                        "Pits\\Pit - a1\\Pit-021.txt", "w")
                    pit22 = open(
                        "Pits\\Pit - a1\\Pit-022.txt", "w")
                    pit23 = open(
                        "Pits\\Pit - a1\\Pit-023.txt", "w")
                    pit24 = open(
                        "Pits\\Pit - a1\\Pit-024.txt", "w")
                    pit25 = open(
                        "Pits\\Pit - a1\\Pit-025.txt", "w")
                    pit26 = open(
                        "Pits\\Pit - a1\\Pit-026.txt", "w")
                    pit0.write("True")
                    pit4.write(ttt)
                    pit5.write("Default")
                    pit6.write("Default")
                ...
                date = tk.Menu(menu, tearoff=0)
                date.add_command(label='Copy all Program Data', command=CAPD)
                date.add_command(label='UD')
                date.add_command(label='UD')
                menu.add_cascade(label='Copy', menu=date)
                submenu = tk.Menu(menu, tearoff=0)
                submenu.add_command(label='Cash Debug', command=CD)
                submenu.add_command(
                    label='Cash Debug Reset Default', command=CDRD)
                menu.add_cascade(label='Debug', menu=submenu)
                menu.add_separator()
        ...
        guest_button = tk.Button(root, text="Login as Guest",
